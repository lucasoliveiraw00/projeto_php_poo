<div class="card fundo card-body">
  <h3 ><b>Editar </b> Pessoa Física</h3><br>
  <form  name="form1" id="form1" method="POST" action="<?= BASE; ?>Pessoa/ValidarDadosPesoaFisica/<?php echo $dados->id; ?>" enctype="multipart/form-data" >
    <div class="row">
        <div class="form-group col-md-4"> 
          <label for="nome">Nome:</label>  
          <div class="input-group mb-3">  
            <input type="text" class="form-control" name="nome" id="nome" placeholder="Preencher" required value="<?php echo $dados->nome; ?>" >
          </div> 
        ...
        <div class="form-group col-md-4"> 
          ...
          <div class="input-group mb-3">  
            <input type="text" class="form-control" name="cpf" id="cpf" placeholder="Preencher" required value="<?php echo $dados->cpf; ?>" >
          </div> 
        ...
        <div class="form-group col-md-4"> 
          ...
          <div class="input-group mb-3">  
            <input type="text" class="form-control" name="rg" id="rg" placeholder="Preencher" required value="<?php echo $dados->rg; ?>" >
          </div> 
        ...
        <div class="form-group col-md-4"> 
          ...
          <div class="input-group mb-3">  
            <input type="text" class="form-control"  name="datanac" id="datanac" placeholder="Preencher" data-date-end-date="0d" readonly required value="<?php echo $dados->dataNasc; ?>" >
        ...
        <div class="form-group col-md-4"> 
          ...
          <div class="input-group mb-3">  
            <input type="text" class="form-control" name="telefone" id="telefone" placeholder="Preencher" required value="<?php echo $dados->telefone; ?>" >
          </div> 
        ...
        <div class="form-group col-md-4"> 
          ...
          <div class="input-group mb-3">  
            <input type="text" class="form-control"  name="cep" id="cep" placeholder="Preencher" required value="<?php echo $dados->cep; ?>" >
            <div class="input-group-append">
        ...
        <div class="form-group col-md-4"> 
          ...
          <div class="input-group mb-3">  
            <input type="text" class="form-control" name="cidade" id="cidade" placeholder="Preencher" required value="<?php echo $dados->cidade; ?>" >
          </div> 
        ...
        <div class="form-group col-md-4"> 
          ...
          <div class="input-group mb-3">  
            <input type="text" class="form-control" name="uf" id="uf" placeholder="Preencher" required value="<?php echo $dados->uf; ?>" >
          </div> 
        ...
        <div class="form-group col-md-4"> 
          ...
          <div class="input-group mb-3">  
            <input type="text" class="form-control" name="bairro" id="bairro" placeholder="Preencher" required value="<?php echo $dados->bairro; ?>" >
          </div> 
        ...
        <div class="form-group col-md-4"> 
          ...
          <div class="input-group mb-3">  
            <input type="text" class="form-control" name="endereco" id="endereco" placeholder="Preencher" required value="<?php echo $dados->endereco; ?>" >
          </div> 
    ...
    <div class="card-footer">
      ...
      <a class="btn btn-danger text-light" onclick="AlertExcluirPessoaFisica('<?php echo $dados->id; ?>');" role="button">Excluir</a>
    </div>
  </form>
</div>
<script>
  $(document).ready(function(){
   $("#sexo").val('<?php echo $dados->sexo; ?>');
  });
