...
<form  name="form2" id="form2" method="POST" action="<?= BASE; ?>Pessoa/ValidarDadosPesoaJuridica" enctype="multipart/form-data" >
  <div class="row">
      <div class="form-group col-md-4"> 
        <label for="razao_social">Razão Social:</label>  
        <div class="input-group mb-3">  
          <input type="text" class="form-control" name="razao_social" id="razao_social" placeholder="Preencher"   >
        </div> 
      ...
      <div class="form-group col-md-4"> 
        ...
        <div class="input-group mb-3">  
          <input type="text" class="form-control" name="nome_fantasia" id="nome_fantasia" placeholder="Preencher" required  >
        </div> 
      ...
      <div class="form-group col-md-4"> 
        ...
        <div class="input-group mb-3">  
          <input type="text" class="form-control cnpj" name="cnpj" id="cnpj" placeholder="Preencher" required  >
        </div> 
      ...
      <div class="form-group col-md-4"> 
        ...
        <div class="input-group mb-3">  
          <input type="number" class="form-control" name="inscricao_esdadual" id="inscricao_esdadual" placeholder="Preencher" required  >
        </div> 
      ...
      <div class="form-group col-md-4"> 
        ...
        <div class="input-group mb-3">  
          <input type="text" class="form-control"  name="data_fundacao" id="data_fundacao" placeholder="Preencher" data-date-end-date="0d" readonly required >
      ...
      <div class="form-group col-md-4"> 
        ...
        <div class="input-group mb-3">  
          <input type="text" class="form-control telefone" name="telefone" id="telefone" placeholder="Preencher" required  >
        </div> 
      ...
      <div class="form-group col-md-4"> 
        ...
        <div class="input-group mb-3">  
          <input type="text" class="form-control cep"  name="cep" id="cep2" placeholder="Preencher" required >
          <div class="input-group-append">
      ...
      <div class="form-group col-md-4"> 
        ...
        <div class="input-group mb-3">  
          <input type="text" class="form-control" name="cidade" id="cidadeform2" placeholder="Preencher" required  >
        </div> 
      ...
      <div class="form-group col-md-4"> 
        ...
        <div class="input-group mb-3">  
          <input type="text" class="form-control uf" name="uf" id="ufform2" placeholder="Preencher" required  >
        </div> 
      ...
      <div class="form-group col-md-4"> 
        ...
        <div class="input-group mb-3">  
          <input type="text" class="form-control" name="bairro" id="bairroform2" placeholder="Preencher" required  >
        </div> 
      ...
      <div class="form-group col-md-4"> 
        ...
        <div class="input-group mb-3">  
          <input type="text" class="form-control" name="endereco" id="enderecoform2" placeholder="Preencher" required  >
        </div> 
